...
{
    public class FinancialMonthlyReports
    {
        private readonly IWebHostEnvironment webHostEnvironment;
        private readonly TheTopDatabaseContext context;
        public FinancialMonthlyReports(IWebHostEnvironment webHostEnvironment, TheTopDatabaseContext context)
        {
        ...
        public PdfPTable SetPageTitle()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("Financial Information", fontStyle));
            pdfCell.Colspan = maxColumn;
        ...
        private void DetailsRow()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("Total Employee Sallary this Month: " + context.EmployeeAttendence.Where(x => x.LogoutTime.Month == DateTime.Now.Month && x.LogoutTime.Year == DateTime.Now.Year).Sum(x => x.Employee.Salary * x.NumberOfHours).ToString() +  ".", fontStyle));
            pdfCell.Colspan = maxColumn;
        ...
        public void ReportBody()
        {
            ...
            fontStyle = FontFactory.GetFont("Tahoma", 9.5f, 1);
